...
class TestCase(unittest.TestCase):
    ...
    def test_game_win(self):
        ...
        try:
            ...
            sys.stdout = original_stdout
        out = fake_stdout.getvalue()
        correct_win = out.find('1 won') != -1
        self.assertTrue(correct_win, msg=f"Expected 1st player win, got {out}")
    ...
    def test_game_loose(self):
        ...
        out = fake_stdout.getvalue()
        correct_win = out.find('-1 won') != -1
        self.assertTrue(correct_win, msg=f"Expected 2nd player win, got {out}")
